...
use Venus\Adapter\PdoDB;

/**
 * Database Driver接口,数据库驱动类的接口
 * Interface IDatabase
 *
 * @package Venus
 */
...
/**
 * Database Driver接口,数据库结果集的接口，提供两种接口
 * Interface IDbRecord
 *
 * @package Zoco
 */
    ...
    public function __construct($dbConfig) {
        switch ($dbConfig['type']) {
            case self::TYPE_MYSQL:
                //$this->_db = new Venus\MySQL($dbConfig);
                break;
            case self::TYPE_MYSQLI:
                //$this->_db = new Venus\MySQLi($dbConfig);
                break;
            default:
                $this->_db = new PdoDB($dbConfig);
                break;
        }
